...
class Config(object):
    ...
    # channels logs
    FORCE_SUB   = os.environ.get("FORCE_SUB", "public_149") 
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002236274426"))
    BIN_CHANNEL = int(os.environ.get("BIN_CHANNEL", "-1002465511950"))
...
"""
    ...
    ABOUT_TXT = """
<b>❍ ᴍʏ ɴᴀᴍᴇ : <a href='https://telegram.me/Navex_69'>ʀᴇɴᴀᴍᴇ ɢᴇɴɪᴇ ʙᴏᴛ</a>
❍ ʜᴏsᴛᴇᴅ ᴏɴ : ᴋᴏʏᴇʙ
❍ ᴅᴀᴛᴀʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ
❍ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ 𝟹
❍ ᴍʏ ᴄʀᴇᴀᴛᴏʀ : <a href='https://telegram.me/Navex_69'>ɴᴀᴠᴇx</a>
...
<code>By: @Navex_69</code>

💬 For Help Contact @Navex_69
"""
